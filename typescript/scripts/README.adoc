...
- https://nodejs.org[Node.js] >=22.12.0
- https://yarnpkg.com[Yarn] 4.12.0 (run `corepack enable` to select the version in `package.json`)
...
Currently the `refundLocktime` is set to 180 days (6 months).
