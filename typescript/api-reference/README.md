...
- [P2TRSignatureFraudChallengeTransactionPreparer](interfaces/P2TRSignatureFraudChallengeTransactionPreparer.md)
...
- [P2TRCompleteV2ChallengeEvidenceCanonicalContext](README.md#p2trcompletev2challengeevidencecanonicalcontext)
- [P2TRCompleteV2SignatureFraudChallengeEvidence](README.md#p2trcompletev2signaturefraudchallengeevidence)
- [P2TRCompleteV2SignatureFraudChallengeIdentity](README.md#p2trcompletev2signaturefraudchallengeidentity)
...
- [P2TRSignatureFraudBoundNonceReservation](README.md#p2trsignaturefraudboundnoncereservation)
...
- [P2TRSignatureFraudChallengeTransactionFeePolicy](README.md#p2trsignaturefraudchallengetransactionfeepolicy)
- [P2TRSignatureFraudDraftChallenge](README.md#p2trsignaturefrauddraftchallenge)
- [P2TRSignatureFraudNonceBurnEnvelope](README.md#p2trsignaturefraudnonceburnenvelope)
...
- [P2TRSignatureFraudPreparedChallengeTransactionResponse](README.md#p2trsignaturefraudpreparedchallengetransactionresponse)
- [P2TRSignatureFraudPreparedNonceBurnTransaction](README.md#p2trsignaturefraudpreparednonceburntransaction)
- [P2TRSignatureFraudPreparedTransactionEnvelope](README.md#p2trsignaturefraudpreparedtransactionenvelope)
- [P2TRSignatureFraudSignedTransactionEnvelope](README.md#p2trsignaturefraudsignedtransactionenvelope)
...
- [P2TRSignatureFraudSigningRequestStage](README.md#p2trsignaturefraudsigningrequeststage)
...
- [P2TRSignatureFraudSubmissionIntent](README.md#p2trsignaturefraudsubmissionintent)
- [P2TRSignatureFraudSubmissionIntentOptions](README.md#p2trsignaturefraudsubmissionintentoptions)
...
- [P2TRWatchtowerCanonicalBitcoinCandidateIdentity](README.md#p2trwatchtowercanonicalbitcoincandidateidentity)
...
- [P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_CHALLENGE\_EVIDENCE\_ABI\_TYPE](README.md#p2tr_signature_fraud_complete_v2_challenge_evidence_abi_type)
- [P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_CHALLENGE\_ID\_DOMAIN](README.md#p2tr_signature_fraud_complete_v2_challenge_id_domain)
- [P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_PROTOCOL](README.md#p2tr_signature_fraud_complete_v2_protocol)
- [P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_PROTOCOL\_ID](README.md#p2tr_signature_fraud_complete_v2_protocol_id)
- [P2TR\_SIGNATURE\_FRAUD\_DRAFT\_CHALLENGE\_ID\_DOMAIN](README.md#p2tr_signature_fraud_draft_challenge_id_domain)
- [P2TR\_SIGNATURE\_FRAUD\_NONCE\_BURN\_GAS\_LIMIT](README.md#p2tr_signature_fraud_nonce_burn_gas_limit)
- [P2TR\_SIGNATURE\_FRAUD\_NONCE\_RESERVATION\_DOMAIN](README.md#p2tr_signature_fraud_nonce_reservation_domain)
...
- [P2TR\_SIGNATURE\_FRAUD\_SUBMISSION\_INTENT\_ID\_DOMAIN](README.md#p2tr_signature_fraud_submission_intent_id_domain)
...
- [buildP2TRCompleteV2SignatureFraudChallengeEvidence](README.md#buildp2trcompletev2signaturefraudchallengeevidence)
- [buildP2TRSignatureFraudBridgeChallengePayload](README.md#buildp2trsignaturefraudbridgechallengepayload)
- [buildP2TRSignatureFraudSubmissionIntent](README.md#buildp2trsignaturefraudsubmissionintent)
- [chainIdFromSigner](README.md#chainidfromsigner)
- [computeElectrumScriptHash](README.md#computeelectrumscripthash)
- [computeP2TRCompleteV2SignatureFraudChallengeIdentity](README.md#computep2trcompletev2signaturefraudchallengeidentity)
- [computeP2TRKeyPathSighash](README.md#computep2trkeypathsighash)
- [computeP2TRSignatureFraudBoundNonceReservationID](README.md#computep2trsignaturefraudboundnoncereservationid)
...
- [computeP2TRSignatureFraudSignerResponseBindingDigest](README.md#computep2trsignaturefraudsignerresponsebindingdigest)
- [computeP2TRSignatureFraudSigningRequestDigest](README.md#computep2trsignaturefraudsigningrequestdigest)
- [computeP2TRSignatureFraudSubmissionIntentID](README.md#computep2trsignaturefraudsubmissionintentid)
...
- [encodeP2TRCompleteV2SignatureFraudChallengePayload](README.md#encodep2trcompletev2signaturefraudchallengepayload)
- [encodeP2TRCompleteV2SignatureFraudRouterSubmitCalldata](README.md#encodep2trcompletev2signaturefraudroutersubmitcalldata)
- [encodeP2TRSignatureFraudBridgeChallengePayload](README.md#encodep2trsignaturefraudbridgechallengepayload)
- [encodeP2TRSignatureFraudRouterSubmitCalldata](README.md#encodep2trsignaturefraudroutersubmitcalldata)
...
- [getP2TRSignatureFraudPreparedTransactionType](README.md#getp2trsignaturefraudpreparedtransactiontype)
- [getRecipientFromEncodedReceiver](README.md#getrecipientfromencodedreceiver)
- [inspectP2TRSignatureFraudPreparedTransactionEnvelope](README.md#inspectp2trsignaturefraudpreparedtransactionenvelope)
...
- [recoverP2TRSignatureFraudPreparedChallengeTransaction](README.md#recoverp2trsignaturefraudpreparedchallengetransaction)
- [recoverP2TRSignatureFraudSignedTransactionEnvelope](README.md#recoverp2trsignaturefraudsignedtransactionenvelope)
...
- [validateP2TRCompleteV2SignatureFraudSubmissionIntent](README.md#validatep2trcompletev2signaturefraudsubmissionintent)
- [validateP2TRInputPrevouts](README.md#validatep2trinputprevouts)
- [validateP2TRSignatureFraudBoundNonceReservation](README.md#validatep2trsignaturefraudboundnoncereservation)
- [validateP2TRSignatureFraudPayloadBounds](README.md#validatep2trsignaturefraudpayloadbounds)
- [validateP2TRSignatureFraudPreparedChallengeReplacementTransaction](README.md#validatep2trsignaturefraudpreparedchallengereplacementtransaction)
- [validateP2TRSignatureFraudPreparedChallengeTransaction](README.md#validatep2trsignaturefraudpreparedchallengetransaction)
- [validateP2TRSignatureFraudPreparedChallengeTransactionReservation](README.md#validatep2trsignaturefraudpreparedchallengetransactionreservation)
- [validateP2TRSignatureFraudPreparedEIP1559ChallengeTransaction](README.md#validatep2trsignaturefraudpreparedeip1559challengetransaction)
- [validateP2TRSignatureFraudPreparedNonceBurnTransaction](README.md#validatep2trsignaturefraudpreparednonceburntransaction)
- [validateP2TRSignatureFraudSignerResponseBinding](README.md#validatep2trsignaturefraudsignerresponsebinding)
...
[src/lib/contracts/bridge.ts:617](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/lib/contracts/bridge.ts#L617)
...
### P2TRCompleteV2ChallengeEvidenceCanonicalContext

Ƭ **P2TRCompleteV2ChallengeEvidenceCanonicalContext**: `Pick`\<[`P2TRSignatureFraudWitnessObservationConsistencyContext`](README.md#p2trsignaturefraudwitnessobservationconsistencycontext), ``"registeredWalletIDs"`` \| ``"walletInputKeyBindings"``\>
...
[src/services/maintenance/p2tr-signature-fraud.ts:556](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L556)

___

### P2TRCompleteV2SignatureFraudChallengeEvidence

Ƭ **P2TRCompleteV2SignatureFraudChallengeEvidence**: `Object`
...
| `bindingTxHash` | [`Hex`](classes/Hex.md) |
| `bridgeAddress` | `string` |
| `bridgeChallengeIdentity` | [`Hex`](classes/Hex.md) |
| `bridgeChallengeKey` | [`Hex`](classes/Hex.md) |
| `domainChainID` | `number` |
| `evidenceProtocolID` | [`Hex`](classes/Hex.md) |
| `inputIndex` | `number` |
| `nonceX` | [`Hex`](classes/Hex.md) |
| `observationID` | [`Hex`](classes/Hex.md) |
| `protocol` | typeof [`P2TR_SIGNATURE_FRAUD_COMPLETE_V2_PROTOCOL`](README.md#p2tr_signature_fraud_complete_v2_protocol) |
| `sighash` | [`Hex`](classes/Hex.md) |
| `signatureScalar` | [`Hex`](classes/Hex.md) |
| `signingKey` | [`Hex`](classes/Hex.md) |
...
### P2TRCompleteV2SignatureFraudChallengeIdentity

Ƭ **P2TRCompleteV2SignatureFraudChallengeIdentity**: `Object`
...
| `signingKey` | [`Hex`](classes/Hex.md) \| `Buffer` \| `string` |
| `walletID` | [`Hex`](classes/Hex.md) \| `Buffer` \| `string` |

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:897](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L897)
...
Ƭ **P2TRSignatureFraudBoundNonceReservation**: `Object`
...
| `reservationEpoch` | `number` | Durable preparation-attempt epoch; retrying one epoch is idempotent. |
| `reservationID` | [`Hex`](classes/Hex.md) | - |
| `sender` | `string` | - |
...
[src/services/maintenance/p2tr-signature-fraud.ts:140](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L140)
...
[src/services/maintenance/p2tr-signature-fraud.ts:136](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L136)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2842](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2842)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2826](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2826)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2837](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2837)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2832](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2832)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2922](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2922)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2874](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2874)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2879](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2879)
...
[src/services/maintenance/p2tr-signature-fraud.ts:223](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L223)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2927](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2927)

___

### P2TRSignatureFraudChallengeTransactionFeePolicy

Ƭ **P2TRSignatureFraudChallengeTransactionFeePolicy**: `Object`
...
| `minimumReplacementFeeBumpBps` | `number` | Minimum transaction-pool replacement bump applied to both fee caps. |
...
[src/services/maintenance/p2tr-signature-fraud.ts:780](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L780)
...
Ƭ **P2TRSignatureFraudNonceBurnEnvelope**: `Object`
...
| `maxPriorityFeePerGas` | `string` | - |
| `nonce` | `number` | - |
| `sender` | `string` | The burn pays itself: `to` is the reserved sender. |

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:646](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L646)

___

### P2TRSignatureFraudNonceReleaseAcknowledgement

Ƭ **P2TRSignatureFraudNonceReleaseAcknowledgement**: `Object`
...
| `reservationID` | [`Hex`](classes/Hex.md) | - |
| `responseDigest` | [`Hex`](classes/Hex.md) | Provider-authenticated or otherwise provider-stable response digest. |
...
Ƭ **P2TRSignatureFraudPreparedChallengeTransaction**: `Object`
...
| :------ | :------ | :------ |
| `calldata?` | `string` | - |
| `chainID?` | `number` | Raw-envelope facts are populated by recovery, never trusted from a signer. |
...
[src/services/maintenance/p2tr-signature-fraud.ts:671](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L671)

___

### P2TRSignatureFraudPreparedChallengeTransactionResponse

Ƭ **P2TRSignatureFraudPreparedChallengeTransactionResponse**: [`P2TRSignatureFraudPreparedChallengeTransaction`](README.md#p2trsignaturefraudpreparedchallengetransaction) & \{ `responseBindingSignature`: `string` ; `signerInvocationID`: [`Hex`](classes/Hex.md) ; `signingRequestDigest`: [`Hex`](classes/Hex.md)  }
...
Ƭ **P2TRSignatureFraudPreparedNonceBurnTransaction**: `Object`
...
[src/services/maintenance/p2tr-signature-fraud.ts:2526](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2526)

___

### P2TRSignatureFraudSignedTransactionEnvelope

Ƭ **P2TRSignatureFraudSignedTransactionEnvelope**: `Object`
...
[src/services/maintenance/p2tr-signature-fraud.ts:773](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L773)
...
[src/services/maintenance/p2tr-signature-fraud.ts:761](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L761)

___

### P2TRSignatureFraudSigningRequestStage

Ƭ **P2TRSignatureFraudSigningRequestStage**: ``"prepare"`` \| ``"replacement"``

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1666](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1666)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2931](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2931)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2943](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2943)

___

### P2TRSignatureFraudSubmissionIntent

Ƭ **P2TRSignatureFraudSubmissionIntent**: `Object`
...
| `bridgeChallengeKey` | [`Hex`](classes/Hex.md) | - |
| `calldata` | `string` | - |
| `chainID` | `number` | Live Ethereum chain ID used by the signed transaction envelope. |
| `domainChainID` | `number` | Immutable registry/router domain used by authorization identity. |
| `evidenceProtocolID` | [`Hex`](classes/Hex.md) | - |
| `inputIndex` | `number` | - |
| `intentID` | [`Hex`](classes/Hex.md) | - |
| `nonceX` | [`Hex`](classes/Hex.md) | - |
...
[src/services/maintenance/p2tr-signature-fraud.ts:588](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L588)

___

### P2TRSignatureFraudSubmissionIntentOptions

Ƭ **P2TRSignatureFraudSubmissionIntentOptions**: `Object`
...
[src/services/maintenance/p2tr-signature-fraud.ts:613](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L613)
...
[src/services/maintenance/p2tr-signature-fraud.ts:257](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L257)
...
[src/services/maintenance/p2tr-signature-fraud.ts:323](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L323)
...
[src/services/maintenance/p2tr-signature-fraud.ts:407](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L407)
...
[src/services/maintenance/p2tr-signature-fraud.ts:418](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L418)
...
[src/services/maintenance/p2tr-signature-fraud.ts:361](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L361)
...
[src/services/maintenance/p2tr-signature-fraud.ts:355](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L355)
...
[src/services/maintenance/p2tr-signature-fraud.ts:351](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L351)
...
[src/services/maintenance/p2tr-signature-fraud.ts:397](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L397)
...
[src/services/maintenance/p2tr-signature-fraud.ts:402](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L402)
...
[src/services/maintenance/p2tr-signature-fraud.ts:337](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L337)
...
[src/services/maintenance/p2tr-signature-fraud.ts:425](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L425)
...
[src/services/maintenance/p2tr-signature-fraud.ts:191](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L191)
...
[src/services/maintenance/p2tr-signature-fraud.ts:206](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L206)
...
[src/services/maintenance/p2tr-signature-fraud.ts:196](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L196)
...
[src/services/maintenance/p2tr-signature-fraud.ts:262](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L262)
...
| `registeredWalletIDs` | ([`Hex`](classes/Hex.md) \| `Buffer` \| `string`)[] | Canonical wallet registry snapshot, never derived from the observation. |
| `spendTypeClassifier?` | [`P2TRSignatureFraudSpendTypeClassifier`](README.md#p2trsignaturefraudspendtypeclassifier) | - |
| `walletInputKeyBindings` | [`P2TRWalletInputKeyBinding`](README.md#p2trwalletinputkeybinding)[] | Canonical exact-outpoint deposit bindings, never derived from the observation. |

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2948](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2948)
...
[src/services/maintenance/p2tr-signature-fraud.ts:165](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L165)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2998](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2998)
...
[src/services/maintenance/p2tr-signature-fraud.ts:3003](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L3003)
...
| `bitcoinTxHash?` | [`Hex`](classes/Hex.md) |
| `bitcoinWtxid?` | [`Hex`](classes/Hex.md) |
...
[src/services/maintenance/p2tr-signature-fraud.ts:3034](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L3034)
...
[src/services/maintenance/p2tr-signature-fraud.ts:3060](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L3060)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2975](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2975)

___

### P2TRWatchtowerConfirmedTransaction

Ƭ **P2TRWatchtowerConfirmedTransaction**: [`P2TRWatchtowerMempoolTransaction`](README.md#p2trwatchtowermempooltransaction) & \{ `bitcoinBlockHash`: [`Hex`](classes/Hex.md) \| `Buffer` \| `string` ; `bitcoinBlockHeight`: `number` ; `canonicalBitcoinCandidateIdentity?`: [`P2TRWatchtowerCanonicalBitcoinCandidateIdentity`](README.md#p2trwatchtowercanonicalbitcoincandidateidentity)  }

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:478](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L478)
...
| :------ | :------ | :------ |
| `complete` | `boolean` | - |
| `orphanedConfirmedTransactions?` | [`P2TRWatchtowerCanonicalBitcoinCandidateIdentity`](README.md#p2trwatchtowercanonicalbitcoincandidateidentity)[] | Previously confirmed candidates orphaned by this canonical scan. |
| `registeredWalletIDs?` | ([`Hex`](classes/Hex.md) \| `Buffer` \| `string`)[] | Canonical, durably indexed wallet registrations applicable to the batch. |
| `transactions` | [`P2TRWatchtowerConfirmedTransaction`](README.md#p2trwatchtowerconfirmedtransaction)[] | - |

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:294](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L294)
...
| :------ | :------ | :------ |
| `bitcoinTxHash` | [`Hex`](classes/Hex.md) \| `Buffer` \| `string` | - |
| `inputPrevouts?` | [`P2TRWalletInputObservationPrevout`](README.md#p2trwalletinputobservationprevout)[] | Optional source-authenticated complete prevout vector. |
| `rawTransaction` | [`BitcoinRawTx`](interfaces/BitcoinRawTx.md) | - |
| `walletInputKeyBindings?` | [`P2TRWalletInputKeyBinding`](README.md#p2trwalletinputkeybinding)[] | - |

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:464](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L464)
...
[src/services/maintenance/p2tr-signature-fraud.ts:201](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L201)
...
• `Const` **P2TR\_SIGNATURE\_FRAUD\_BRIDGE\_CHALLENGE\_ID\_DOMAIN**: ``"tbtc-p2tr-signature-fraud-authorization-v3"``

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2965](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2965)
...
COMPLETE_V2 uses its v3 challenge identity directly as the key.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2969](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2969)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2858](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2858)

___

### P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_CHALLENGE\_EVIDENCE\_ABI\_TYPE

• `Const` **P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_CHALLENGE\_EVIDENCE\_ABI\_TYPE**: ``"tuple(bytes32 walletID,bytes32 signingKey,bytes32 bindingTxHash,uint32 bindingOutputIndex,bytes32 sighash,bytes32 nonceX,bytes32 signatureScalar)"``
...
### P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_CHALLENGE\_ID\_DOMAIN

• `Const` **P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_CHALLENGE\_ID\_DOMAIN**: ``"tbtc-p2tr-signature-fraud-authorization-v3"``
...
### P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_PROTOCOL

• `Const` **P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_PROTOCOL**: ``"COMPLETE_V2"``
...
### P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_PROTOCOL\_ID

• `Const` **P2TR\_SIGNATURE\_FRAUD\_COMPLETE\_V2\_PROTOCOL\_ID**: `string`
...
[src/services/maintenance/p2tr-signature-fraud.ts:537](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L537)
...
### P2TR\_SIGNATURE\_FRAUD\_NONCE\_BURN\_GAS\_LIMIT

• `Const` **P2TR\_SIGNATURE\_FRAUD\_NONCE\_BURN\_GAS\_LIMIT**: ``"21000"``

Exact intrinsic gas of a value-less self-transfer; a burn is nothing else.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:636](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L636)

___

### P2TR\_SIGNATURE\_FRAUD\_NONCE\_RESERVATION\_DOMAIN

• `Const` **P2TR\_SIGNATURE\_FRAUD\_NONCE\_RESERVATION\_DOMAIN**: ``"tbtc-p2tr-signature-fraud-nonce-reservation-v1"``
...
### P2TR\_SIGNATURE\_FRAUD\_SUBMISSION\_INTENT\_ID\_DOMAIN

• `Const` **P2TR\_SIGNATURE\_FRAUD\_SUBMISSION\_INTENT\_ID\_DOMAIN**: ``"tbtc-p2tr-signature-fraud-submission-intent-complete-v2"``
...
[src/services/maintenance/p2tr-signature-fraud.ts:524](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L524)
...
[src/services/maintenance/p2tr-signature-fraud.ts:2959](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2959)
...
[src/services/maintenance/p2tr-signature-fraud.ts:4731](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L4731)
...
▸ **buildP2TRCompleteV2SignatureFraudChallengeEvidence**(`observation`, `domain`, `canonical`): [`P2TRCompleteV2SignatureFraudChallengeEvidence`](README.md#p2trcompletev2signaturefraudchallengeevidence)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `observation` | [`P2TRSignatureFraudWitnessObservation`](README.md#p2trsignaturefraudwitnessobservation) | Authenticated witness observation for the input. |
| `domain` | [`P2TRSignatureFraudBridgeChallengeDomain`](README.md#p2trsignaturefraudbridgechallengedomain) | Bridge challenge domain the observation's challenge key, if present, must have been derived under. |
| `canonical` | [`P2TRCompleteV2ChallengeEvidenceCanonicalContext`](README.md#p2trcompletev2challengeevidencecanonicalcontext) | Canonical context the observation is checked against: registered wallet IDs and per-input wallet key bindings. |

#### Returns

[`P2TRCompleteV2SignatureFraudChallengeEvidence`](README.md#p2trcompletev2signaturefraudchallengeevidence)

The fixed COMPLETE_V2 evidence record for this input.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:961](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L961)
...
▸ **buildP2TRSignatureFraudSubmissionIntent**(`evidence`, `options`): [`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `evidence` | [`P2TRCompleteV2SignatureFraudChallengeEvidence`](README.md#p2trcompletev2signaturefraudchallengeevidence) | Constructed COMPLETE_V2 evidence the intent submits. |
| `options` | [`P2TRSignatureFraudSubmissionIntentOptions`](README.md#p2trsignaturefraudsubmissionintentoptions) | Chain, Bridge, router and deposit parameters that fix the call the intent authorizes. |

#### Returns

[`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent)

The submission intent, with its derived `intentID`.
...
▸ **computeP2TRCompleteV2SignatureFraudChallengeIdentity**(`identity`): [`Hex`](classes/Hex.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `identity` | [`P2TRCompleteV2SignatureFraudChallengeIdentity`](README.md#p2trcompletev2signaturefraudchallengeidentity) | Chain, Bridge, wallet, signing-key and sighash fields the on-chain identity commits to. |

#### Returns

[`Hex`](classes/Hex.md)

The 32-byte challenge identity the router will recompute.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:912](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L912)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5571](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5571)

___

### computeP2TRSignatureFraudBoundNonceReservationID

▸ **computeP2TRSignatureFraudBoundNonceReservationID**(`intent`, `outboxRecordID`, `generation`, `reservationEpoch`, `lane`, `nonce`): [`Hex`](classes/Hex.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `intent` | [`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent) | Durable submission intent the reservation is bound to. |
| `outboxRecordID` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Outbox record the reservation belongs to. |
| `generation` | `number` | Outbox record generation the reservation was taken under. |
| `reservationEpoch` | `number` | Reservation epoch within that generation. |
| `lane` | [`P2TRSignatureFraudSignerLaneIdentity`](README.md#p2trsignaturefraudsignerlaneidentity) | Signer lane identity that owns the nonce. |
| `nonce` | `number` | Sender nonce being reserved. |

#### Returns

[`Hex`](classes/Hex.md)

The EIP-712 digest that doubles as the reservation identity.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1536](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1536)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `challenge` | [`P2TRSignatureFraudBridgeChallengeIdentity`](README.md#p2trsignaturefraudbridgechallengeidentity) | COMPLETE_V2 domain and signed-authorization tuple. |

#### Returns

[`Hex`](classes/Hex.md)

32-byte COMPLETE_V2 Bridge challenge identity.
...
▸ **computeP2TRSignatureFraudSignerResponseBindingDigest**(`signingRequestDigest`, `signerInvocationID`, `transactionHash`): [`Hex`](classes/Hex.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `signingRequestDigest` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Digest of the exact signer request. |
| `signerInvocationID` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Deterministic identifier for the signer call. |
| `transactionHash` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Hash of the transaction returned by the signer. |

#### Returns

[`Hex`](classes/Hex.md)

Digest authenticating the exact signer response.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1839](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1839)

___

### computeP2TRSignatureFraudSigningRequestDigest

▸ **computeP2TRSignatureFraudSigningRequestDigest**(`stage`, `intent`, `reservation`, `feePolicy`, `signerInvocationID`, `previousTransactionHash?`): [`Hex`](classes/Hex.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `stage` | [`P2TRSignatureFraudSigningRequestStage`](README.md#p2trsignaturefraudsigningrequeststage) | Signer API stage being invoked. |
| `intent` | [`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent) | Exact fraud-challenge submission intent. |
| `reservation` | [`P2TRSignatureFraudBoundNonceReservation`](README.md#p2trsignaturefraudboundnoncereservation) | Authenticated nonce reservation selected for the call. |
| `feePolicy` | [`P2TRSignatureFraudChallengeTransactionFeePolicy`](README.md#p2trsignaturefraudchallengetransactionfeepolicy) | Manifest-bound fee policy selected for the call. |
| `signerInvocationID` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Deterministic identifier for this signer call. |
| `previousTransactionHash?` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Prior signed transaction for a replacement. |

#### Returns

[`Hex`](classes/Hex.md)

Digest committing to the complete signer request.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1682](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1682)

___

### computeP2TRSignatureFraudSubmissionIntentID

▸ **computeP2TRSignatureFraudSubmissionIntentID**(`intent`): [`Hex`](classes/Hex.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `intent` | `Omit`\<[`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent), ``"intentID"``\> |
...
[src/services/maintenance/p2tr-signature-fraud.ts:1339](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1339)
...
[src/services/maintenance/p2tr-signature-fraud.ts:3822](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L3822)
...
▸ **encodeP2TRCompleteV2SignatureFraudChallengePayload**(`evidence`): `string`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `evidence` | [`P2TRCompleteV2SignatureFraudChallengeEvidence`](README.md#p2trcompletev2signaturefraudchallengeevidence) | Constructed COMPLETE_V2 evidence for a single input. |

#### Returns

`string`

The ABI-encoded challenge payload, rejected unless it is exactly
         224 bytes.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1096](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1096)

___

### encodeP2TRCompleteV2SignatureFraudRouterSubmitCalldata

▸ **encodeP2TRCompleteV2SignatureFraudRouterSubmitCalldata**(`evidence`): `string`
...
Calldata for the router's `processP2TRSignatureFraudChallenge`
         submit action.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1130](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1130)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `observation` | [`P2TRSignatureFraudWitnessObservation`](README.md#p2trsignaturefraudwitnessobservation) | Parsed witness observation to encode. |

#### Returns

`string`

ABI-encoded COMPLETE_V2 evidence or legacy domainless payload.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:6156](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L6156)

___

### encodeP2TRSignatureFraudRouterSubmitCalldata

▸ **encodeP2TRSignatureFraudRouterSubmitCalldata**(`evidence`): `string`

#### Parameters

| Name | Type |
| :------ | :------ |
| `evidence` | [`P2TRCompleteV2SignatureFraudChallengeEvidence`](README.md#p2trcompletev2signaturefraudchallengeevidence) |
...
Use the protocol-specific COMPLETE_V2 encoder.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1143](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1143)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5294](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5294)
...
[src/services/maintenance/p2tr-signature-fraud.ts:6325](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L6325)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5638](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5638)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5676](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5676)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `rawTransaction` | `string` | Signed Ethereum transaction bytes. |

#### Returns

``0`` \| ``1`` \| ``2`` \| ``3`` \| ``4``

The parsed Ethereum transaction type.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2602](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2602)
...
▸ **inspectP2TRSignatureFraudPreparedTransactionEnvelope**(`rawTransaction`): [`P2TRSignatureFraudPreparedTransactionEnvelope`](README.md#p2trsignaturefraudpreparedtransactionenvelope)
...
The recovered envelope type and EIP-1559 fee fields, when present.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2543](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2543)
...
[src/services/maintenance/p2tr-signature-fraud.ts:4028](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L4028)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5233](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5233)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5134](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5134)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5196](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5196)

___

### recoverP2TRSignatureFraudPreparedChallengeTransaction

▸ **recoverP2TRSignatureFraudPreparedChallengeTransaction**(`intent`, `rawTransaction`): [`P2TRSignatureFraudPreparedChallengeTransaction`](README.md#p2trsignaturefraudpreparedchallengetransaction)
...
The prepared transaction with every envelope fact rederived from
         the raw bytes rather than taken from the signer response.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2227](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2227)

___

### recoverP2TRSignatureFraudSignedTransactionEnvelope

▸ **recoverP2TRSignatureFraudSignedTransactionEnvelope**(`rawTransaction`): [`P2TRSignatureFraudSignedTransactionEnvelope`](README.md#p2trsignaturefraudsignedtransactionenvelope)
...
Hash, sender, nonce, chain, destination, calldata, and value
         recovered only from the signed bytes.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2014](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2014)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5446](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5446)
...
[src/services/maintenance/p2tr-signature-fraud.ts:4138](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L4138)
...
[src/services/maintenance/p2tr-signature-fraud.ts:4085](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L4085)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5340](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5340)
...
[src/services/maintenance/p2tr-signature-fraud.ts:4049](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L4049)
...
▸ **validateP2TRCompleteV2SignatureFraudSubmissionIntent**(`intent`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `intent` | [`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent) | Durable submission intent rehydrated from the outbox. |

#### Returns

`void`

An empty return value; throws if the intent is not bound to the
         COMPLETE_V2 evidence protocol.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1155](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1155)

___

### validateP2TRInputPrevouts

▸ **validateP2TRInputPrevouts**(`rawTransaction`, `inputPrevouts`): [`P2TRWalletInputObservationPrevout`](README.md#p2trwalletinputobservationprevout)[]
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `rawTransaction` | [`BitcoinRawTx`](interfaces/BitcoinRawTx.md) | Raw Bitcoin transaction whose input vector the prevout records must describe. |
| `inputPrevouts` | [`P2TRWalletInputObservationPrevout`](README.md#p2trwalletinputobservationprevout)[] | Source-provided per-input prevout records (outpoint, amount, script). Length must equal the transaction's input vector length and each entry must name its input's outpoint exactly. |

#### Returns

[`P2TRWalletInputObservationPrevout`](README.md#p2trwalletinputobservationprevout)[]

The prevout records in transaction input order, once every entry has
...
▸ **validateP2TRSignatureFraudBoundNonceReservation**(`intent`, `outboxRecordID`, `generation`, `reservationEpoch`, `lane`, `reservation`): [`P2TRSignatureFraudBoundNonceReservation`](README.md#p2trsignaturefraudboundnoncereservation)
...
| `generation` | `number` | Outbox record generation the reservation was taken under. |
| `reservationEpoch` | `number` | Reservation epoch within that generation. |
| `lane` | [`P2TRSignatureFraudSignerLaneIdentity`](README.md#p2trsignaturefraudsignerlaneidentity) | Signer lane identity that must have produced the reservation. |
| `reservation` | [`P2TRSignatureFraudBoundNonceReservation`](README.md#p2trsignaturefraudboundnoncereservation) | Reservation to authenticate, including its binding signature over the EIP-712 reservation digest. |

#### Returns

[`P2TRSignatureFraudBoundNonceReservation`](README.md#p2trsignaturefraudboundnoncereservation)

The reservation in normalized form, with its recomputed identity.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:1575](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L1575)
...
[src/services/maintenance/p2tr-signature-fraud.ts:5379](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L5379)
...
The validated replacement transaction.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2710](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2710)
...
Authenticates signed challenge bytes, signer invocation, and response.
...
| `invocation?` | [`P2TRSignatureFraudSignerInvocationRequest`](README.md#p2trsignaturefraudsignerinvocationrequest) | Exact signer invocation, when validating a fresh response. |

#### Returns

[`P2TRSignatureFraudPreparedChallengeTransaction`](README.md#p2trsignaturefraudpreparedchallengetransaction)

The canonical prepared transaction derived from the signed bytes.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2276](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2276)

___

### validateP2TRSignatureFraudPreparedChallengeTransactionReservation

▸ **validateP2TRSignatureFraudPreparedChallengeTransactionReservation**(`intent`, `reservation`, `prepared`): [`P2TRSignatureFraudPreparedChallengeTransaction`](README.md#p2trsignaturefraudpreparedchallengetransaction)
...
| :------ | :------ | :------ |
| `intent` | [`P2TRSignatureFraudSubmissionIntent`](README.md#p2trsignaturefraudsubmissionintent) | Durable submission intent the signed bytes must satisfy. |
| `reservation` | [`P2TRSignatureFraudBoundNonceReservation`](README.md#p2trsignaturefraudboundnoncereservation) | Authenticated nonce reservation the transaction must consume, sender and nonce exactly. |
| `prepared` | [`P2TRSignatureFraudPreparedChallengeTransaction`](README.md#p2trsignaturefraudpreparedchallengetransaction) | Prepared transaction whose raw bytes are authenticated. |
...
The validated EIP-1559 transaction.
...
▸ **validateP2TRSignatureFraudPreparedEIP1559ChallengeTransaction**(`intent`, `prepared`): [`P2TRSignatureFraudPreparedChallengeTransaction`](README.md#p2trsignaturefraudpreparedchallengetransaction)
...
The validated transaction, extended with its EIP-1559 fee fields.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2615](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2615)

___

### validateP2TRSignatureFraudPreparedNonceBurnTransaction

▸ **validateP2TRSignatureFraudPreparedNonceBurnTransaction**(`reservation`, `envelope`, `prepared`, `invocation?`): [`P2TRSignatureFraudPreparedNonceBurnTransaction`](README.md#p2trsignaturefraudpreparednonceburntransaction)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `reservation` | [`P2TRSignatureFraudBoundNonceReservation`](README.md#p2trsignaturefraudboundnoncereservation) | Durable reservation whose nonce the burn must spend. |
| `envelope` | [`P2TRSignatureFraudNonceBurnEnvelope`](README.md#p2trsignaturefraudnonceburnenvelope) | Burn envelope the signer was asked to sign: sender, nonce, gas limit and the EIP-1559 fee caps. |
| `prepared` | [`P2TRSignatureFraudPreparedNonceBurnTransaction`](README.md#p2trsignaturefraudpreparednonceburntransaction) | Prepared burn whose raw bytes are authenticated. |
| `invocation?` | [`P2TRSignatureFraudSignerInvocationRequest`](README.md#p2trsignaturefraudsignerinvocationrequest) | Signer invocation request the burn must echo. Optional on the same terms as the challenge validator: supplied, the echo must match exactly; omitted, it is preserved untouched. |

#### Returns

[`P2TRSignatureFraudPreparedNonceBurnTransaction`](README.md#p2trsignaturefraudpreparednonceburntransaction)

The burn with hash, sender, nonce and fee fields rederived from the
         raw bytes rather than taken from the caller.

#### Defined in

[src/services/maintenance/p2tr-signature-fraud.ts:2407](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L2407)

___

### validateP2TRSignatureFraudSignerResponseBinding

▸ **validateP2TRSignatureFraudSignerResponseBinding**(`response`, `expectedSigningRequestDigest`, `expectedSignerInvocationID`, `actualTransactionHash`, `expectedSender`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `response` | [`P2TRSignatureFraudPreparedChallengeTransactionResponse`](README.md#p2trsignaturefraudpreparedchallengetransactionresponse) | Prepared transaction response returned by the signer. |
| `expectedSigningRequestDigest` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Expected exact request digest. |
| `expectedSignerInvocationID` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Expected deterministic invocation ID. |
| `actualTransactionHash` | `string` \| [`Hex`](classes/Hex.md) \| `Buffer`\<`ArrayBufferLike`\> | Hash rederived from the returned transaction. |
| `expectedSender` | `string` | Address owning the authenticated nonce reservation. |

#### Returns

`void`

An empty return value; throws if the response is not authentic.
...
[src/services/maintenance/p2tr-signature-fraud.ts:6432](https://github.com/threshold-network/tbtc-v2/blob/main/typescript/src/services/maintenance/p2tr-signature-fraud.ts#L6432)
