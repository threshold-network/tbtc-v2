...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const implementationDeployment = await deploy("ArbitrumWormholeGatewayUpgradedImplementation", {
    contract: "contracts/wormhole/ArbitrumWormholeGatewayUpgraded.sol:ArbitrumWormholeGatewayUpgraded",
    from: deployer,
