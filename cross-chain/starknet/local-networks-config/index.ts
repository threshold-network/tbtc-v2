...
// directly to drop the cross-org dependency; see
// threshold-network/keep-common's dependency plan for rationale. Do not add
// new features here beyond what upstream published — this is a frozen copy.
import fs from "fs"
