...
https://github.com/keep-network/tbtc-v2/actions/workflows/monitoring.yml[image:https://github.com/threshold-network/tbtc-v2/actions/workflows/monitoring.yml/badge.svg[Monitoring build status]]
